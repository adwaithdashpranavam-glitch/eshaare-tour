// Comprehensive country data for visa profile forms.
// Each entry: { name, code (ISO-2), dial (calling code), flag (emoji) }
// Used by SearchableCountryDropdown, MultiCountryDropdown and CountryCodeDropdown.
