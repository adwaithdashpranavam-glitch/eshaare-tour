...
export const VisaServicesPage = () => {
  ...
  return (
    <div className="bg-[#1D503A] min-h-screen text-[#F5F1E8] font-sans pb-24">
      {/* Page Hero Banner */}
      <section className="relative py-28 overflow-hidden bg-[#2B2723] border-b border-[#4D4740] text-center">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-[#1D503A]/85 backdrop-blur-[2px]"></div>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-gradient-to-r from-[#7A8F6B] to-[#627555] text-[#1D503A] font-bold rounded-lg hover:opacity-95 transition-all text-xs uppercase tracking-wider"
            >
              Retry Loading
            </button>
          </div>
                  ...
                  <div className="p-6 pt-4 flex-1 flex flex-col justify-between space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-4">
                      ...
                      <Link
                        ...
                        className="w-full text-center py-2.5 bg-gradient-to-r from-[#7A8F6B] to-[#627555] text-[#1D503A] font-bold rounded-lg text-xs uppercase tracking-wider hover:opacity-95 transition-all shadow-sm flex items-center justify-center"
                      >
                        Apply Now
                      </Link>
                    </div>
