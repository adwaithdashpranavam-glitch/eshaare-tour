...
- System recommendations provided: ${eligibilityResult.recommendations.join(" | ")}`,
  ...
  return (
    ...
    >
      {/* Page Hero Banner */}
      <section className="relative py-28 overflow-hidden text-center bg-[#1D503A]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#0B221A]/75 via-[#1D503A]/80 to-[#1D503A]"></div>
          {/* Decorative accent light blur */}
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-[#7FE6A2] opacity-15 rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop space-y-6">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 bg-white/10 border border-white/10 rounded-full backdrop-blur-md">
            <span className="w-1.5 h-1.5 rounded-full bg-[#7FE6A2] animate-pulse" />
            <span className="text-[10px] font-bold text-[#EAE3D5] uppercase tracking-wider font-mono">Premium Document Audits</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold font-display text-white tracking-tight leading-tight max-w-3xl mx-auto">
            Global Visa Assistance Services
          </h1>
          <p className="text-sm md:text-base text-[#EAE3D5]/80 max-w-xl mx-auto leading-relaxed">
      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          {/* LEFT COLUMN: Available Visa Grid Listings (60% width on Desktop) */}
          <div className="w-full lg:w-[60%] order-1">
            ...
            {loading ? (
              ...
              /* Grid of Visa Cards (2 columns layout to fit split-sidebar) */
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {visaTypes.map((visa) => {
          ...
          {/* RIGHT COLUMN: Interactive Eligibility Checker (40% width on Desktop, Sticky scroll) */}
          <div className="w-full lg:w-[40%] order-2 lg:sticky lg:top-28">
            <div className="bg-white/95 backdrop-blur-md border border-outline-variant/10 rounded-3xl premium-shadow p-6 md:p-8 space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-outline-variant/10 pb-4">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="font-headline-md text-body-lg font-bold text-gray-900">Visa Eligibility Assessment</h3>
              ...
              {!checkerSubmitted ? (
                <div className="space-y-6">
                  ...
                  {checkerStep === 0 && (
                    <div className="space-y-5 animate-[fadeIn_0.25s_ease-out]">
                      <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Step 1: Travel Intentions</h4>
                  ...
                  {checkerStep === 1 && (
                    <div className="space-y-5 animate-[fadeIn_0.25s_ease-out]">
                      <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Step 2: Professional Details</h4>
                  ...
                  {checkerStep === 2 && (
                    <div className="space-y-5 animate-[fadeIn_0.25s_ease-out]">
                      <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Step 3: Finances & History</h4>
                ...
                /* Thank you page once lead submitted */
