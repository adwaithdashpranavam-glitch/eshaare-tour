      ...
      <AnimatePresence>
        {globeLoading && (
          <motion.div
            ...
            className="absolute inset-0 z-50 flex items-center justify-center bg-[#1D503A]"
          >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain">
              ...
              <div className="relative h-44 w-full shrink-0 sm:h-52">
                ...
                />
                {/* Gradient overlays */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#1D503A] via-black/30 to-transparent" />
