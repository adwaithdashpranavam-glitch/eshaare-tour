  ...
  return (
    <div className="flex flex-col gap-1.5 rounded-xl border border-white/[0.07] bg-white/[0.04] p-3 backdrop-blur-sm transition-colors hover:bg-white/[0.07]">
      <div className="flex items-center gap-1.5">
        <span className="text-[#D4AF37]/70">{icon}</span>
        <span className="text-[9px] font-bold uppercase tracking-[0.15em] text-white/35">
          {label}
        </span>
      </div>
      <p
        className={`text-xl font-bold leading-none ${accent ? "text-[#D4AF37]" : "text-white"}`}
      >
        {value}
      </p>
      {sub && (
...
function DestCard({ dest }) {
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-white/[0.07] bg-white/[0.03] transition-all duration-300 hover:border-[#D4AF37]/25 hover:bg-white/[0.06]">
      {/* Image */}
      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <ChevronRight
          size={14}
          className="text-white/20 transition-colors group-hover:text-[#D4AF37]"
        />
      </div>
    </div>
  );
          ...
          >
            <div className="flex flex-col items-center gap-5">
              ...
              <div className="text-center">
                <p className="text-sm font-semibold tracking-[0.2em] uppercase text-[#D4AF37]">
                  Loading Earth
                </p>
        ...
        {selectedCountry && (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="mb-1 flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D4AF37]/80">
                        Destination
                      </span>
                    </div>
                  ...
                  {/* Pulse marker */}
                  <span
                    className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[#D4AF37]/30 bg-[#D4AF37]/10"
                    aria-hidden
                  >
              ...
              <div className="space-y-4 px-6 py-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="rounded-full bg-[#D4AF37]/10 px-2 py-0.5 text-[9px] font-bold text-[#D4AF37]">
            ...
            <div className="shrink-0 border-t border-white/[0.06] bg-black/40 px-6 py-4 backdrop-blur-xl">
              <Link
                to="/packages"
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#c9832a] via-[#D4AF37] to-[#e8c96a] py-4 text-sm font-bold text-black shadow-lg shadow-[#D4AF37]/10 transition-all duration-200 hover:scale-[1.02] hover:shadow-[#D4AF37]/25 focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#D4AF37]"
              >
                <Sparkles size={14} />
                View All Packages
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain">
              ...
              <div className="relative h-44 w-full shrink-0 sm:h-52">
                ...
                {/* Country badge */}
                <span className="absolute right-5 top-5 rounded-full border border-[#D4AF37]/30 bg-black/50 px-3 py-1 text-[9px] font-bold uppercase tracking-[0.15em] text-[#D4AF37] backdrop-blur-md">
              ...
              <div className="space-y-4 px-6 py-5">
                ...
                <div>
                  <div className="mb-3 flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#D4AF37]/80">
                      About This Landmark
                    </span>
                  </div>
            ...
            <div className="shrink-0 border-t border-white/[0.06] bg-black/40 px-6 py-4 backdrop-blur-xl">
              ...
              <button
                ...
                className="mt-2 flex w-full items-center justify-center gap-1.5 rounded-xl border border-white/[0.08] bg-white/[0.03] py-3 text-xs font-semibold text-white/50 transition hover:bg-white/[0.07] hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#D4AF37]"
              >
                <Compass size={11} />
                Zoom Out to Globe
              </button>
