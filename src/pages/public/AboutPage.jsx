      ...
      <div className="max-w-container-max mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h3 className="font-headline-md text-headline-md text-primary">Our Story</h3>
            <p className="text-on-surface-variant text-body-md leading-relaxed">
        ...
        <div className="space-y-8">
          <h3 className="font-headline-md text-headline-md text-primary text-center">Our Core Pillars</h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div className="bg-surface-container-lowest p-8 border border-outline-variant/10 rounded-2xl text-center space-y-4 premium-shadow">
              ...
              <h4 className="font-headline-md text-body-lg font-bold text-primary">Uncompromised Accuracy</h4>
            ...
            <div className="bg-surface-container-lowest p-8 border border-outline-variant/10 rounded-2xl text-center space-y-4 premium-shadow">
              ...
              <h4 className="font-headline-md text-body-lg font-bold text-primary">Elite Service</h4>
              <p className="text-on-surface-variant text-body-sm leading-relaxed">
            ...
            <div className="bg-surface-container-lowest p-8 border border-outline-variant/10 rounded-2xl text-center space-y-4 premium-shadow">
              ...
              <h4 className="font-headline-md text-body-lg font-bold text-primary">Client-First Care</h4>
              <p className="text-on-surface-variant text-body-sm leading-relaxed">
