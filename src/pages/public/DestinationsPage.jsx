...
export const DestinationsPage = () => {
  const destinations = [
    { name: "France", region: "Europe", visas: "Schengen Visa required", image: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=500&q=80" },
    { name: "Italy", region: "Europe", visas: "Schengen Visa required", image: "https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=500&q=80" },
    { name: "United Kingdom", region: "Europe", visas: "UK Standard Visitor Visa", image: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&w=500&q=80" },
    { name: "Japan", region: "Asia", visas: "Japan Short-stay Visa", image: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=500&q=80" },
    { name: "Switzerland", region: "Europe", visas: "Schengen Visa required", image: "https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?auto=format&fit=crop&w=500&q=80" },
    { name: "United States", region: "Americas", visas: "US B1/B2 Visa", image: "https://images.unsplash.com/photo-1501594907352-04cda38ebc29?auto=format&fit=crop&w=500&q=80" }
  ];
