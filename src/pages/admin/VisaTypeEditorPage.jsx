          ...
          <div className="bg-primary-container/40 border border-on-primary-fixed-variant rounded-card p-6 border-l-4 border-l-secondary space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
              <div className="md:col-span-2 space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <label className="px-4 py-2 border border-[#453E1D] text-white hover:border-[#EAC784] hover:text-[#EAC784] rounded text-xs font-bold uppercase tracking-wider cursor-pointer transition-colors flex items-center space-x-1.5">
                    {uploading ? (
                      <>
                  ...
                  {formData.imageUrl && (
                    <button
                      ...
                      className="px-3 py-2 text-xs font-bold text-[#EEDADA]/45 hover:text-error-red transition-colors"
                    >
                      Clear Image
                    </button>
                  )}
                ...
                <div className="bg-primary-container/20 p-4 rounded-xl border border-on-primary-fixed-variant/60 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 pt-2 border-t border-on-primary-fixed-variant/40">
                      <div className="flex justify-between items-center">
                        <label className="text-[9px] font-bold uppercase text-[#EEDADA]/50">Features Checklist</label>
                        <button
                          type="button"
                        ...
                        {formData.supportPackages.standard.features.map((feat, idx) => (
                          <div key={idx} className="flex items-center space-x-2 bg-primary-container/40 p-1.5 rounded border border-on-primary-fixed-variant/40">
                            <input
                              ...
                              className="rounded border-[#453E1D] text-secondary focus:ring-secondary/50 bg-[#231F0D] h-3.5 w-3.5"
                              title="Is Included"
                            />
                            <input
                              type="text"
                        ...
                        {formData.supportPackages.premium.features.map((feat, idx) => (
                          <div key={idx} className="flex items-center space-x-2 bg-primary-container/40 p-1.5 rounded border border-on-primary-fixed-variant/40">
                            ...
                            <button
                              ...
                              className={`p-0.5 rounded text-[10px] ${feat.highlighted ? "text-amber-500 hover:text-amber-600" : "text-on-primary-container/30 hover:text-[#EEDADA]/70"}`}
