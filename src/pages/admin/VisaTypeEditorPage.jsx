          ...
          <div className="bg-primary-container/40 border border-on-primary-fixed-variant rounded-card p-6 border-l-4 border-l-secondary space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
              <div className="md:col-span-2 space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <label className="px-4 py-2 border border-[#1A2B47] text-white hover:border-[#C9A84C] hover:text-[#C9A84C] rounded text-xs font-bold uppercase tracking-wider cursor-pointer transition-colors flex items-center space-x-1.5">
                    {uploading ? (
                      <>
                  ...
                  {formData.imageUrl && (
                    <button
                      ...
                      className="px-3 py-2 text-xs font-bold text-[#EDE0C4]/45 hover:text-error-red transition-colors"
                    >
                      Clear Image
                    </button>
                  )}
